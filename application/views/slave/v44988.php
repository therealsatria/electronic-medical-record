<div class="row">
  <div class="col-sm-3">
      <a href="../seek" class="btn btn-block btn-outline-success"><i class="nav-icon far fa-save"></i>&nbsp Kembali</a>
  </div>
</div>
<br>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="no_rm" value="<?php echo $rm; ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Nama Lengkap</label>
                      <input type="text" class="form-control" id="nama_lengkap" value="<?php echo $k->nm_pasien ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="tmpt_lhr" value="<?= $k->tmp_lahir ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Tanggal Lahir</label>
                      <input type="date" class="form-control" id="tgl_lhr" value="<?= $k->tgl_lahir ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Alamat</label>
                      <input type="text" class="form-control" id="alamat" value="<?= $k->alamat ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="agama" id="agama">
                        <option disabled><?= $k->agama ?></option>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>No KTP</label>
                      <input type="text" class="form-control" id="no_ktp" value="<?= $k->no_ktp ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nm_ibu" value="<?= $k->nm_ibu ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" class="form-control" id="email" value="<?= $k->email ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Telp</label>
                      <input type="text" class="form-control" id="tlp" value="<?= $k->no_tlp ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="pekerjaan" value="<?= $k->pekerjaan ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label>Nama lengkap</label>
                      <input type="text" class="form-control" id="nama_pj" value="<?= $k->namakeluarga ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Alamat</label>
                      <input type="text" class="form-control" id="alamat_pj" value="<?= $k->alamatpj ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Pekerjaan</label>
                      <input type="text" class="form-control" id="pekerjaan_pj" value="<?= $k->pekerjaanpj ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
