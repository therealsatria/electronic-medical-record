...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nm_dpn_pj_f2" id="nm_dpn_pj_f2" value="" aria-describedby="helpId" placeholder="nama wali">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nm_pasien_f2" id="nm_pasien_f2" value="" aria-describedby="helpId" placeholder="nama pasien">
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-sm-12">
        ...
        <canvas id="ttd_wali" src="" class="efekttd" style="width: 300px;"></cavnas>
    </div>
</div><button onclick="reset3()">reset</button></br>
...
<div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <canvas id="ttd_wali2" src="" class="efekttd" style="width: 300px;"></canvas>
            <button onclick="reset4()">reset</button>
        </div>
        
        <div class="col-sm-6">
            <label for="">Saksi</label></br>
            <canvas id="ttd_saksi" src="" class="efekttd" style="width: 300px;"></canvas>
