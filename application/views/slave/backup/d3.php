<div class="row">
	<div class="col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="nm_pasien_f3" id="nm_pasien_f3" value="<?= $k->nm_pasien ?>" aria-describedby="helpId"
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="tgl_lhr_f3" id="tgl_lhr_f3" value="<?= $k->tgl_lahir ?>" aria-describedby="helpId" placeholder="tanggal lahir">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Jenis Kelamin</label>
			<input type="text" class="form-control" name="jk_f3" id="jk_f3" value="<?= $k->jk ?>" aria-describedby="helpId" >
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="alamat_f3" id="alamat_f3" value="<?= $k->alamat ?>" aria-describedby="helpId" placeholder="alamat pasien">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Paviliun</label>
			<select class="form-control" name="kls_perwtn" id="">
...
<div class="row">
	<div class="col-sm-12">
		<p><strong>
				<center>PASIEN ATAU WALI DIMINTA MEMBACA, MEMAHAMI, DAN MENGISI
					INFORMASI BERIKUT :</center>
			</strong></p>
		<p class="">
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Nama</label>
			<input type="text" class="form-control" name="nm_dpn_pj_f3" id="nm_dpn_pj_f3" value="<?= $k->namakeluarga ?>" aria-describedby="helpId" placeholder="nama wali">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Tanggal Lahir</label>
			<input type="text" class="form-control" name="tgl_pj_f3" id="tgl_pj_f3" value="" aria-describedby="helpId" placeholder="">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Alamat</label>
			<input type="text" class="form-control" name="alamat_pj_f3" id="alamat_pj_f3" value="<?= $k->alamatpj ?>"
				aria-describedby="helpId" placeholder="alamat wali">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Nomor Telepon</label>
			<input type="text" class="form-control" name="tlp_pj_f3" id="tlp_pj_f3" value=""
				aria-describedby="helpId" placeholder="no telp">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<p class="">
			...
			<strong>I. PERSETUJUAN UNTUK PERAWATAN DAN PENGOBATAN</strong></br>
			...
			mereka.</br></br>
			<strong>II. BARANG-BARANG MILIK PASIEN</strong></br>
			...
			<strong>III. KEINGINAN PRIVASI PASIEN</strong></br>

			<div class="col-sm-4">
				<div class="form-group">
					<select class="form-control" name="privasi" id="privasi">
						<option>Saya mengizinkan</option>
						<option>Saya tidak mengizinkan</option>
					</select>
				</div>
			</div>
			Rumah sakit memberi akses bagi keluarga dan handai taulan serta
			orang-orang yang menengok / menemui saya.</br></br>
			<strong>IV. PERSETUJUAN PELEPASAN INFORMASI</strong></br>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="nm1_form3" id="nm1_form3" value="-" aria-describedby="helpId"
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					<label for="">Alamat</label>
					<input type="text" class="form-control" name="almt1_form3" id="almt1_form3" value="-" aria-describedby="helpId"
						placeholder="rekam medis">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					<label for="">2. Nama</label>
					<input type="text" class="form-control" name="nm2_form3" id="nm2_form3" value="-" aria-describedby="helpId"
						placeholder="rekam medis">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					<label for="">Alamat</label>
					<input type="text" class="form-control" name="almt2_form3" id="almt2_form3" value="-" aria-describedby="helpId"
						placeholder="rekam medis">
				</div>
			</div>
		</div>
		</br>
		<p><strong>V. HAK DAN TANGGUNG JAWAB PASIEN</strong></br>
		...
		<p class="small">
			...
			<strong>- KEWAJIBAN PASIEN :</strong></br>
		...
		<p>
			<strong>VI. INFORMASI RAWAT INAP</strong></br>
			...
			identitasnya.</br></br>
			<strong>VII. INFORMASI BIAYA</strong></br>
...
<div class="row">
	<div class="col-sm-6">
		<center>
			...
			<canvas id="ttd_saksi_f3" class="efekttd" style="width: 300px;"></canvas><br>
		   <button type="button" class="btn btn-danger" onclick="hapusttd6()">Reset</button>
		</center>
	</div>
	<div class="col-sm-6">
		<center>
			<label for="">Pasien / Wali</label></br>
			<canvas id="ttd_pasien_f3" class="efekttd" style="width: 300px;"></canvas><br>
		   <button type="button" class="btn btn-danger" onclick="hapusttd7()">Reset</button>
		</center>
	</div>
</div>
