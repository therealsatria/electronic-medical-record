...
<div class="row">
	<div class="col-sm-3">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="no_rm" id="no_rm" value="<?= $rm ?>" aria-describedby="helpId"
	...
	<div class="col-sm-5">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="nm_pasien" id="nm_pasien" value="<?= $k->nm_pasien ?>" aria-describedby="helpId"
	...
	<div class="col-sm-2">
		<div class="form-group">
			...
			<select class="form-control" name="gol_drh" id="gol_drh">
				...
				<option selected><?= $k->gol_darah ?></option>
			</select>
		</div>
	</div>
	<div class="col-sm-2">
...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="tmpt_lhr" id="tmpt_lhr" value="<?= $k->tmp_lahir ?>" aria-describedby="helpId"
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="date" class="form-control" name="tgl_lhr" id="tgl_lhr" value="<?= $k->tgl_lahir ?>" aria-describedby="helpId"
				placeholder="">
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			...
			<select class="form-control" name="agama" id="agama">
				...
				<option>-</option>
				<option selected><?= $k->agama ?></option>
			</select>
		</div>
...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="no_ktp" id="no_ktp" value="<?= $k->no_ktp ?>" aria-describedby="helpId"
				placeholder="no ktp">
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="nm_ibu" id="nm_ibu" value="<?= $k->nm_ibu ?>" aria-describedby="helpId"
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<select class="form-control" name="stts_nikah" id="stts_nikah">
				...
				<option selected><?= $k->stts_nikah ?></option>
			</select>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-8">
		<div class="form-group">
			...
			<!-- ### -->
			<textarea class="form-control" name="alamat" id="alamat" value="<?= $k->alamat ?>" rows="3" placeholder="alamat lengkap sesuai ktp"><?= $k->alamat ?></textarea>
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			<label for="">Email</label>
			<input type="text" class="form-control" name="email" id="email" value="<?= $k->email ?>" aria-describedby="helpId"
				placeholder="email">
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="tlp" id="tlp" value="<?= $k->no_tlp ?>" aria-describedby="helpId"
						placeholder="no telp">
				</div>
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<!-- ### -->
			<input type="text" class="form-control" name="pkrjn" id="pkrjn" value="<?= $k->pekerjaan ?>" aria-describedby="helpId"
...
<div class="row">
	<div class="col-lg-6">
		...
		<div class="input-group mb-3">
			...
			<input type="date" name="tgl_prnh_drwt" id="tgl_prnh_drwt" value="<?= $k->tgl_daftar ?>" class="form-control"
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Nama Lengkap</label>
			<input type="text" class="form-control" name="nm_dpn_pj" id="nm_dpn_pj" value="<?= $k->namakeluarga ?>" aria-describedby="helpId"
				placeholder="nama lengkap">
		</div>
	</div>
	<div class="col-sm-2">
...
<div class="row">
	<div class="col-sm-8">
		<div class="form-group">
			<label for="">Alamat Rumah (Sesuai KTP)</label>
			<textarea class="form-control" name="alamat_pj" id="alamat_pj" value="<?= $k->alamatpj ?>" rows="3"
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Pekerjaan</label>
			<input type="text" class="form-control" name="pkrjn_pj" id="pkrjn_pj" value="<?= $k->pekerjaanpj ?>" aria-describedby="helpId"
				placeholder="pekerjaan">
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
			...
			<option selected><?= $k->keluarga ?></option>
			</select>
		</div>
	</div>
</div>
