...
<div class="row">
   <div class="col-sm-12">
      ...
      <div class="form-group">
         ...
         <input type="text" class="form-control" name="nm_dpn_pj_f4" id="nm_dpn_pj_f4" value=""
...
<div class="row">
   <div class="col-sm-12">
      <div class="form-group">
         ...
         <input type="text" class="form-control" name="hub_pj_f4" id="hub_pj_f4" value="" aria-describedby="helpId"
...
<div class="row">
   <div class="col-sm-12">
      <p>Sanggup untuk membayar biaya operasi / perawatan / pengobatan untuk
         <div class="col-sm-4">
            <input type="text" class="form-control" name="nm_pasien_f4" id="nm_pasien_f4" disabled></br>
         </div>
...
<div class="row">
   <div class="col-sm-6">
      <center>
         ...
         <canvas id="ttd_saksi_f4" src="" class="efekttd" style="width: 300px;"></canvas>
   ...
   <div class="col-sm-6">
      <center>
         ...
         <canvas id="ttd_pasien_f4" src="" class="efekttd" style="width: 300px;"></canvas>
...
<div class="row">
   ...
   <div class="col-2" style="margin-top: 31px;">
      ...
      <button type="button" class="btn btn-success" onclick="updatedata()">Simpan Form</button>
   </div>
</div>
