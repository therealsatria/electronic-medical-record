<div class="row">
	<div class="col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="nm_pasien_f3" id="nm_pasien_f3" value="" aria-describedby="helpId"
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="tgl_lhr_f3" id="tgl_lhr_f3" value="" aria-describedby="helpId" placeholder="tanggal lahir">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Jenis Kelamin</label>
			<input type="text" class="form-control" name="jk_f3" id="jk_f3" value="" aria-describedby="helpId" >
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="alamat_f3" id="alamat_f3" value="" aria-describedby="helpId" placeholder="alamat pasien">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Nama</label>
			<input type="text" class="form-control" name="nm_dpn_pj_f3" id="nm_dpn_pj_f3" value="" aria-describedby="helpId" placeholder="nama wali">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			<label for="">Alamat</label>
			<input type="text" class="form-control" name="alamat_pj_f3" id="alamat_pj_f3" value=""
